...
class PropertyPhotoSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        # DRF sukut bo'yicha to'liq manzil beradi; frontend bir originda ishlashi
        # uchun nisbiy yo'l qoldiramiz (/media/...).
        if instance.image:
...
class PropertySerializer(serializers.ModelSerializer):
    ...
    #: Kartada ko'rsatiladigan birinchi rasm (bo'lmasa null).
    ...
    def get_cover(self, obj):
        # Nisbiy yo'l qaytariladi — frontend uni o'z origini orqali proksilaydi.
